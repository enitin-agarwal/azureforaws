...
この演習では、ハイパーパラメーターを調整する実験を実行するためのコードをノートブックで提供します。

1. Jupyter ホーム ページで、ノートブック リポジトリを複製した **/users/*your-user-name*/mslearn-dp100** フォルダーを参照し、**ハイパーパラメーターのチューニング**ノートブックを開きます。
